...
export function WorkflowBeam({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full items-center justify-center overflow-hidden p-4 md:p-10",
        className
      )}
      ref={containerRef}
    >
      <div className="flex size-full max-w-2xl flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center gap-6">
          <div className="flex flex-col items-center">
            ...
            <span className="text-[10px] md:text-xs font-semibold text-slate-500 mt-2">Google One</span>
          </div>
          <div className="flex flex-col items-center">
            <Circle ref={div2Ref}>
              <Icons.notion />
            </Circle>
            <span className="text-[10px] md:text-xs font-semibold text-slate-500 mt-2">Notion</span>
          </div>
          <div className="flex flex-col items-center">
            <Circle ref={div3Ref}>
              <Icons.openai />
            </Circle>
            <span className="text-[10px] md:text-xs font-semibold text-slate-500 mt-2">ChatGPT</span>
          </div>
          <div className="flex flex-col items-center">
            <Circle ref={div4Ref}>
              <Icons.whatsapp />
            </Circle>
            <span className="text-[10px] md:text-xs font-semibold text-slate-500 mt-2">WhatsApp API</span>
          </div>
          <div className="flex flex-col items-center">
            <Circle ref={div5Ref}>
              <Icons.zapier />
            </Circle>
            <span className="text-[10px] md:text-xs font-semibold text-slate-500 mt-2">Zapier</span>
          </div>
        </div>
        <div className="flex flex-col justify-center items-center">
          <Circle ref={div6Ref} className="size-20 border-brand-500 bg-brand-50 shadow-glow-sm">
            <Sparkles className="w-8 h-8 text-brand-600" />
          </Circle>
          <span className="text-sm font-black text-brand-600 mt-3 tracking-tight">Payifi</span>
        </div>
        <div className="flex flex-col justify-center items-center">
          <Circle ref={div7Ref} className="size-16">
            <Icons.user />
          </Circle>
          <span className="text-xs font-bold text-slate-900 mt-2">You</span>
        </div>
      </div>
